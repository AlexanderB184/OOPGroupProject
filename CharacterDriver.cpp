...
int main(void) {
  ...
  // test 6
  {
    ...
    if (Test6.StatusEffect[0][0].duration != 9) {
      cout << "Test 6 Failed Invalid Duration "
           << Test6.StatusEffect[0][0].duration << endl;
    }
  }
  // test 7
  {
    ...
    if (Test7.StatusEffect[0][0].duration != 9) {
      cout << "Test 7 Failed Invalid Duration "
           << Test7.StatusEffect[0][0].duration << endl;
    }
  }
  ...
  // test 8
  {
    ...
    Test7.numberOfEffects = 1;
    Test7.ApplyStatus();
    if (Test7.HP != 100 || Test7.dead ||
        Test7.StatusEffect[0][0].duration != 9) {
  ...
  // Test 15
  {
    ...
    if (Test7.StatusEffect[0][0].duration != 9) {
      cout << "Test 15 Failed Invalid Duration "
           << Test7.StatusEffect[0][0].duration << endl;
    }
    if (Test7.StatusEffect[1][0].duration != 9) {
      cout << "Test 15 Failed Invalid Duration "
           << Test7.StatusEffect[1][0].duration << endl;
    }
  }
  // Test 16
  {
    ...
    Test7.StatusEffect = Effects;
    Test7.ApplyStatus();
    if (Test7.HP != 35 || Test7.dead ||
        Test7.StatusEffect[1][0].duration != 9 ||
        Test7.StatusEffect[0][0].duration != 9) {
  ...
  // Test 17
  {
    ...
    Test7.StatusEffect = Effects;
    Test7.ApplyStatus();
    if (Test7.HP != 50 || Test7.dead ||
        Test7.StatusEffect[0][0].duration != 9 ||
        Test7.StatusEffect[1][0].duration != 9 ||
        Test7.StatusEffect[2][0].duration != 9) {
